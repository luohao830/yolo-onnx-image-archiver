---
name: YOLO 公网多用户推理平台
description: 匿名用户提交图片/压缩包任务，查看进度、日志并下载结果的冷静工程化界面。
colors:
  primary: "#2563eb"
  primary-deep: "#1d4ed8"
  primary-soft: "#dbeafe"
...
- **匿名≠低信任**：无需登录的体验更要在文案、错误处理和视觉稳定感上建立信任。
...
- **Don't** 使用渐变文字、大数字指标、营销话术或抽象插图——这是 SaaS 营销落地页的 cliché，会拖慢匿名用户的任务路径。
- **Don't** 使用大红大绿的状态色块和密集表格——这是传统运维后台的外观，只有内行才能看懂。
- **Don't** 让界面冷淡到没有反馈、错误不解释。匿名用户需要每一步都被确认。
